        ...
        namespace trace {
            ...
            namespace v1 {
                ...
                interface IResourceSpans {
                    ...
                    instrumentationLibrarySpans?: (opentelemetry.proto.trace.v1.IInstrumentationLibrarySpans[]|null);
                ...
                class ResourceSpans implements IResourceSpans {
                    ...
                    /** ResourceSpans instrumentationLibrarySpans. */
                    public instrumentationLibrarySpans: opentelemetry.proto.trace.v1.IInstrumentationLibrarySpans[];
                ...
                /** Represents an InstrumentationLibrarySpans. */
                class InstrumentationLibrarySpans implements IInstrumentationLibrarySpans {

                    /**
                     * Constructs a new InstrumentationLibrarySpans.
                     * @param [properties] Properties to set
                     */
                    constructor(properties?: opentelemetry.proto.trace.v1.IInstrumentationLibrarySpans);
                     ...
                     * @param [properties] Properties to set
                     * @returns InstrumentationLibrarySpans instance
                     */
                    public static create(properties?: opentelemetry.proto.trace.v1.IInstrumentationLibrarySpans): opentelemetry.proto.trace.v1.InstrumentationLibrarySpans;
                     ...
                     * @param message InstrumentationLibrarySpans message or plain object to encode
                     * @param [writer] Writer to encode to
                     * @returns Writer
                     */
                    public static encode(message: opentelemetry.proto.trace.v1.IInstrumentationLibrarySpans, writer?: $protobuf.Writer): $protobuf.Writer;
                     ...
                     * @returns Writer
                     */
                    public static encodeDelimited(message: opentelemetry.proto.trace.v1.IInstrumentationLibrarySpans, writer?: $protobuf.Writer): $protobuf.Writer;

                    /**
                     * Decodes an InstrumentationLibrarySpans message from the specified reader or buffer.
                     * @param reader Reader or buffer to decode from
                     * @param [length] Message length if known beforehand
                     * @returns InstrumentationLibrarySpans
                     * @throws {Error} If the payload is not a reader or valid buffer
                     * @throws {$protobuf.util.ProtocolError} If required fields are missing
                     */
                    public static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): opentelemetry.proto.trace.v1.InstrumentationLibrarySpans;
                     ...
                     * @throws {$protobuf.util.ProtocolError} If required fields are missing
                     */
                    public static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): opentelemetry.proto.trace.v1.InstrumentationLibrarySpans;
                     ...
                     * @returns InstrumentationLibrarySpans
                     */
                    public static fromObject(object: { [k: string]: any }): opentelemetry.proto.trace.v1.InstrumentationLibrarySpans;

                    /**
                     * Creates a plain object from an InstrumentationLibrarySpans message. Also converts values to other types if specified.
                     * @param message InstrumentationLibrarySpans
                     * @param [options] Conversion options
                     * @returns Plain object
                     */
                    public static toObject(message: opentelemetry.proto.trace.v1.InstrumentationLibrarySpans, options?: $protobuf.IConversionOptions): { [k: string]: any };
